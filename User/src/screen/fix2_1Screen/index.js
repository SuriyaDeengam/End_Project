            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F1_1'}) }}
                        >
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                ...
                                'เปิดไฟหน้ารถ ไฟหรี่ ไฟสูง และบีบแตร เพื่อดูว่าใช้งานได้หรือไม่') }}
                        >
                            <Image
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F1_2'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                'วิธีการตรวจสอบเบื้องต้น :',
                                'ตรวจเช็คน้ำกลั่นใน Battery ว่ามีหรือไม่') }}
                        >
                            <Image
                                source={require('../../resource/question-gray.png')}
                                style={{ resizeMode: 'stretch', height: 25, width: 25 }}
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F1_3'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                'วิธีการตรวจสอบเบื้องต้น',
                                'ตรวจเช็คที่หน้าปัดว่ามีสัญลักษณ์รูป Battery ขึ้นหรือไม่ เมื่อทำการสตาร์ทหาก Battery ปกติไฟสัญลักษณ์จะดับลง') }}
                        >
                            <Image
                                source={require('../../resource/question-gray.png')}
                                style={{ resizeMode: 'stretch', height: 25, width: 25 }}
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F1_4'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F1_5'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
