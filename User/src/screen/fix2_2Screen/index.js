            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F2_1'}) }}
                        >
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                ...
                                'ตรวจสอบน้ำมันในังน้ำมันว่ามีหรือไม่') }}
                        >
                            <Image
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F2_2'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                'วิธีการตรวจสอบเบื้องต้น :',
                                'ถอดสาบที่กรองเบนซิน แล้วลองสตาร์ทรถดูว่ามีน้ำมันออกมาหรือไม่') }}
                        >
                            <Image
                                source={require('../../resource/question-gray.png')}
                                style={{ resizeMode: 'stretch', height: 25, width: 25 }}
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F2_3'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                'วิธีการตรวจสอบเบื้องต้น',
                                'ทำการถอดสายที่มาจากคอยล์จานจ่ายเข้าเครื่องยนต์ จากนั้นนำไปวางตรงส่วนที่เครื่องยนต์เป็นโลหะ หากมีประกายไฟเกิดขึ้น แสดงว่าจานจ่ายไฟทำงานปกติ') }}
                        >
                            <Image
                                source={require('../../resource/question-gray.png')}
                                style={{ resizeMode: 'stretch', height: 25, width: 25 }}
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F2_4'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
                    ...
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
                            ...
                            onPress={() => { Alert.alert(
                                'วิธีการตรวจสอบเบื้องต้น',
                                'ตรวจสอบที่สายพานหน้าเครื่องว่าขาดหรือไม่') }}
                        >
                            <Image
                                source={require('../../resource/question-gray.png')}
                                style={{ resizeMode: 'stretch', height: 25, width: 25 }}
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 6 }}>
                        <TouchableOpacity
                            style={{}}
                            onPress={() => { props.navigation.navigate('Fix3', {call: 'F2_5'}) }}
                        >
                            <View style={{ marginTop: 15, marginRight: 15, marginLeft: 15, flexDirection: 'row' }}>
                                <View style={{ flex: 2 }}>
                                    <Image
