...
export default class P2_11 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
            ...
            <View style={{ flex: 1, backgroundColor: "#e7e1da" }}>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View style={{ backgroundColor: "#e7e1da" }}>
                        <View style={{ flex: 1, marginTop: '10%', marginLeft: '5%', }}>
                            <Text style={{ color: "#707070", fontSize: 15, textAlign: 'center' }}>
                                ห้ามสตาร์ทเครื่องโดยเด็ดขาด
                            </Text>
                            <Text style={{ color: "#707070", fontSize: 15, textAlign: 'center' }}>
                                อาจทำให้เครื่องยนต์ได้รับความเสียหายเพิ่ม
                            </Text>
                            <Text style={{ color: "#707070", fontSize: 15, textAlign: 'center' }}>
                                แนะนำให้เรียกช่างมาทำการเปลี่ยนถ่ายน้ำมันในทันที
                            </Text>
                        </View>
                    </View>
                    <View style={{ marginTop: '8%', marginRight: '10%', marginLeft: '8%', flexDirection: 'row', }}>
                        ...
                        <View style={{ flex: 20, marginTop: '8%', marginTop: '3%', marginLeft: '5%', }}>
