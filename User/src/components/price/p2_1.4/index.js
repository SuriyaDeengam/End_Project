...
export default class P2_1_4 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
            ...
            <View style={{ flex: 1, backgroundColor: "#e7e1da" ,marginBottom:35}}>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View style={{ marginRight: '10%', marginLeft: '10%', flexDirection: 'row', }}>
                        ...
                        <View style={{ flex: 20, marginTop: '3%', marginLeft: '3%', }}>
                            <Text style={{ color: "#707070", fontSize: 15, textAlign: 'left' }}>
                                เหมาะสำหรับเครื่องยนต์ ขนาด 1,000 - 1,500 ซี.ซี.
                            </Text>
                        </View>
                    </View>
                    <View style={{ marginRight: '10%', marginLeft: '10%', flexDirection: 'row', }}>
                    ...
                    <View style={{ marginRight: '10%', marginLeft: '10%', flexDirection: 'row', }}>
                        ...
                        <View style={{ flex: 20, marginTop: '3%', marginLeft: '3%', }}>
                            <Text style={{ color: "#707070", fontSize: 15, textAlign: 'left' }}>
                                เหมาะสำหรับรถกะบะ และรถที่มีเครื่องยนต์ขนาด 2,500 - 3,000 ซี.ซี.
                            </Text>
                        </View>
                    </View>
                    <View style={{ marginRight: '10%', marginLeft: '10%', flexDirection: 'row', }}>
