...
import { StyleSheet, Text, ActivityIndicator, View, SectionList, TouchableOpacity, Alert } from 'react-native';
...
export default class App extends React.Component {
    ...
    async componentWillMount() {
        ...
        b = 0;
        aa = [];
        /////////add array doc///////////////////////////////.where("ok", "==", true).get()
        const dbh = firebase.firestore();
        dbh.collection("/Project/work/first").get().then(function (querySnapshot) {
